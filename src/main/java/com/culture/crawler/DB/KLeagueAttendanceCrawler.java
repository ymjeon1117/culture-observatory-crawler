    ...
    public static void insertKLeagueToDb(
        ...
        try (java.sql.Connection conn = java.sql.DriverManager.getConnection(
            ...
            String sql = "INSERT INTO colct_sports_match_info " +
                    "(MATCH_DE, BASE_YEAR, BASE_MT, BASE_DAY, GRP_NM, LEA_NM, " +
                    "HOME_TEAM_NM, AWAY_TEAM_NM, STDM_NM, SPORTS_VIEWNG_NMPR_CO, COLCT_DE, UPDT_DE) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            System.err.println("❌ K리그 insert 실패: " + e.getMessage());
        }
    }
